...
import numpy as np
from PySpice1v5.Config import ConfigInstall
from PySpice1v5.Probe.WaveForm import (
...
from PySpice1v5.Tools.EnumFactory import EnumFactory
from PySpice1v5.Unit import u_V, u_A, u_s, u_Hz, u_F, u_Degree
...
class NgSpiceShared:
    ...
    def setup_platform(cls):
        ...
        if _ is not None:
            cls.LIBRARY_PATH = _
            ngspice_path = Path(_).parent.parent
    ...
    def _load_library(self, verbose):
        ...
        if ConfigInstall.OS.on_windows:
            ...
            if 'SPICE_LIB_DIR' not in os.environ:
                _ = str(Path(self.NGSPICE_PATH).joinpath('share', 'ngspice', 'scripts', 'spinit'))
